...
export function useChat({
  ...
  const sendMessage = useCallback(
    ...
    [stream, sessionId, config.userId, activeAssistant?.config, recursionLimit, onHistoryRevalidate]
  );
  ...
  const continueStream = useCallback(
    ...
    [stream, sessionId, config.userId, activeAssistant?.config, onHistoryRevalidate, recursionLimit]
  );
